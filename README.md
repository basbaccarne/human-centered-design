...
Dit is de algemene overzichtspagina voor het vak gebruiksgericht ontwerpen aan de opleiding [Industrieel Ingenieur: Industrieel Ontwerpen @ Universiteit Gent](https://studiekiezer.ugent.be/brochurescan/283885329) (2de bachelor). 
...
Een interactief spel waarmee bewoners van woonzorgcentra (65+) zelfstandig hun motorische en cognitieve vaardigheden verbeteren via op maat gemaakte oefeningen van de kinesist.
...
⚙[GitHub page](https://github.com/JADEVANDENABB/UCD/blob/main/Petch.md)

## 13. VibeLink
*by Cezar Herbots & Warre De Vriendt*   

Kotstudenten gemakkelijker laten communiceren met medekotstudenten.
...
⚙[GitHub page](https://github.com/DePieter/TakeFive)
